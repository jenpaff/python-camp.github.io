...
*   [1\. Lösungen zu den letzten Aufgaben](#sec-1)
    *   [1.1. Sternenpyramide](#sec-1-1)
    *   [1.2. Zahlenmuster](#sec-1-2)
*   [2\. Listen](#sec-2)
    *   [2.1. Sortieren](#sec-2-1)
    *   [2.2. Negative Indexe](#sec-2-2)
    *   [2.3. Übung - Sortieren und negative Indexe](#sec-2-3)
    *   [2.4. Slicing](#sec-2-4)
    *   [2.5. Übung - Slicing](#sec-2-5)
*   [3\. Funktionen](#sec-3)
    *   [3.1. Übung: Hangman](#sec-3-1)
*   [4\. Wörterbücher](#sec-4)
*   [5\. User-Eingaben](#sec-5)
    *   [5.1. Übung - Interaktives Hangman spiel](#sec-5-1)
    *   [5.2. Übung - Wörterbücher und Nutzereingaben](#sec-5-2)
*   [6\. Wiederholung](#sec-6)
    *   [6.1. Funktionen](#sec-6-1)
    *   [6.2. Fortgeschritten: Number Guessing Game](#sec-6-2)
